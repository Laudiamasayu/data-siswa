                ...
                <div class="bg-white shadow-md h-auto mb-4 max-w-4xl relative">
                    ...
                    <div class="mb-4 m-3 flex flex-wrap">
                        <div class="mx-auto mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nama_siswa" type="text" placeholder="Nama Siswa">
                        </div>
                    </div>
                    <div class="mb-4 m-3 flex flex-wrap">
                    ...
                    <div class="mb-4 m-3 flex flex-wrap">
                        <div class="mx-auto mb-4">
                            ...
                            <textarea class="shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="alamat" placeholder="Alamat"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 m-3 flex flex-wrap">
                        <div class="mx-auto mb-4">
                            ...
                            <select id="jurusan" name="jurusan" class="shadow appearance-none border rounded w-96 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div class="absolute bottom-0 right-0 mb-1 mr-4">
                        <button class="bg-[#A084E8] hover:bg-[#6F61C0] text-white font-semibold py-2 px-4 rounded-lg">
                            Simpan Data
                        </button>
                    </div>
                </div>
